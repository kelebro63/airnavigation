...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        DeputyDao.createTable(db, ifNotExists);
        VotingResultDao.createTable(db, ifNotExists);
        VotingDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        TopicDao.dropTable(db, ifExists);
        DeputyDao.dropTable(db, ifExists);
        VotingResultDao.dropTable(db, ifExists);
        VotingDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(DeputyDao.class);
        registerDaoClass(VotingResultDao.class);
        registerDaoClass(VotingDao.class);
    }
