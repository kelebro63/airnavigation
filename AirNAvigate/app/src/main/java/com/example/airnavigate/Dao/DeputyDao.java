...
import com.example.airnavigate.Model.Converters.ActivityListPropertyConverter;
import com.example.airnavigate.Model.Converters.EducationListPropertyConverter;
...
public class DeputyDao extends AbstractDao<Deputy, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Activity = new Property(20, String.class, "activity", false, "ACTIVITY");
        public final static Property Educations = new Property(21, String.class, "educations", false, "EDUCATIONS");
    };

    private final ActivityListPropertyConverter activityConverter = new ActivityListPropertyConverter();
    private final EducationListPropertyConverter educationsConverter = new EducationListPropertyConverter();
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DEPUTY\" (" + //
                ...
                "\"ACTIVITY\" TEXT," + // 20: activity
                "\"EDUCATIONS\" TEXT);"); // 21: educations
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Deputy entity) {
        ...
        ActivityArrayList activity = entity.getActivity();
        if (activity != null) {
            stmt.bindString(21, activityConverter.convertToDatabaseValue(activity));
        }
 
        EducationArrayList educations = entity.getEducations();
        if (educations != null) {
            stmt.bindString(22, educationsConverter.convertToDatabaseValue(educations));
        }
    }
    ...
    public Deputy readEntity(Cursor cursor, int offset) {
        Deputy entity = new Deputy( //
            ...
            cursor.isNull(offset + 20) ? null : activityConverter.convertToEntityProperty(cursor.getString(offset + 20)), // activity
            cursor.isNull(offset + 21) ? null : educationsConverter.convertToEntityProperty(cursor.getString(offset + 21)) // educations
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Deputy entity, int offset) {
        ...
        entity.setActivity(cursor.isNull(offset + 20) ? null : activityConverter.convertToEntityProperty(cursor.getString(offset + 20)));
        entity.setEducations(cursor.isNull(offset + 21) ? null : educationsConverter.convertToEntityProperty(cursor.getString(offset + 21)));
     }
